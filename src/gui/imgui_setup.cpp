...
bool    ImGui_ImplGlfwGL3_Init(GLFWwindow* window, bool install_callbacks, const string& dataDir)
{
    g_Window = window;
	...
	style->Colors[ImGuiCol_HeaderActive] = ImVec4(0.46f, 0.45f, 0.47f, 1.00f);
    ...
    string font = dataDir + "/" + "fonts/Ruda-Bold.ttf";
